...
float4 _SplitToningShadow;
float4 _SplitToningHightLight;
...
float3 ColorGradeSplitToning(float3 color,bool useACES)
{
	...
	float3 shadow = lerp(0.5,_SplitToningShadow.rgb,1.0-t);
	float3 hightlights = lerp(0.5,_SplitToningHightLight.rgb,t);
