...
float GetOtherShadow (
	...
	float3 surfaceToLihgt = other.lightPositionWS - surfaceWS.position;
	float distanceToLightPlane = dot(surfaceToLihgt,lightPlane);
...
)
{
	...
	{
		shadow = 
		GetBakedShadow(global.shadowMask,
